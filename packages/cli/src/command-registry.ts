...
export const commandDefinitions: readonly CommandDefinition[] = [
	...
	},
	{
		...
		usageLines: [
			...
			"journal list     List logbook entries (filters: --meat, --min-rating, --search)",
			"journal show <id>  Show one logbook entry",
			"journal cost     Summarize cook costs across matching logbook entries",
			"journal export   Export matching logbook entries as JSON or CSV",
